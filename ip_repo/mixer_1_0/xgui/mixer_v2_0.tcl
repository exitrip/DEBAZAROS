...
proc update_PARAM_VALUE.OUT_NUM { PARAM_VALUE.OUT_NUM } {
	# Procedure called to update OUT_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OUT_NUM { PARAM_VALUE.OUT_NUM } {
	# Procedure called to validate OUT_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.OUT_NUM { MODELPARAM_VALUE.OUT_NUM PARAM_VALUE.OUT_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OUT_NUM}] ${MODELPARAM_VALUE.OUT_NUM}
}
